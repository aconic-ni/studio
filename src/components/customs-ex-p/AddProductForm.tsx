...
const productSchema = z.object({
  ...
  packageQuantity: z.coerce.number().int().min(0, "Cantidad de Bultos debe ser al menos 0").optional(),
  unitQuantity: z.coerce.number().int().min(0, "Cantidad de Unidades debe ser al menos 0").optional(),
...
export const AddProductForm: FC<AddProductFormProps> = ({ onSubmit, initialData }) => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleFormSubmit)} id="product-form-page" className="space-y-6 pt-4 pb-4">
